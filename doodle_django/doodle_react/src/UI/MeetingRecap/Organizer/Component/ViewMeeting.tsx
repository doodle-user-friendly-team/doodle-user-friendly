...
// importing alert and alert title for sending email
import {
    Box,
    Button,
    Dialog,
...
// add for sending email
// Dialog for sending meeting's link by email
